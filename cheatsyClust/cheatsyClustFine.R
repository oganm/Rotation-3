...
foldChange2 = function (group1, group2, f = 10){
  ...
  groupAverage2[g26 & g19] = tryCatch({(apply(exprData[group2, g26 & g19], 2, max))},
                                      error = function(cond){
  ...
  groupAverage1[g16 & g29] = tryCatch({(apply(exprData[group1,g16 & g29], 2, max))},
                                      error = function(cond){
                                        print('I hate you damn it!')
                                        return(max(exprData[group2,g16 & g29]))
                                      })
  
  groupAverage2[g16 & g29] = tryCatch({(apply(exprData[group2,g16 & g29], 2, min))},
                                      error = function(cond){
                                        print('I hate you damn it!')
                                        return(min(exprData[group2,g16 & g29]))
                                      })
  
  groupAverage1[g26 & g19] = tryCatch({(apply(exprData[group1,g26 & g19], 2, min))},
                                      error = function(cond){
                                        print('I hate you damn it!')
                                        return(min(exprData[group2,g26 & g19]))
                                      })
...
fc = foldChange(groupAverage1, groupAverage2 )
